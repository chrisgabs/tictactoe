...
const Home: NextPage = () => {
  return (
      <div id="main-container">
        <div className="p2 pieces-container">
          <div className="piece s1"></div>
          <div className="piece s2"></div>
          <div className="piece s3"></div>
          <div className="piece s4"></div>
          <div className="piece s5"></div>
        </div>
        <div className="parent">
          <div className="row">
            <div className="tile" id="t1"></div>
        ...
        <div className="p1 pieces-container">
          <div className="piece s1"></div>
          <div className="piece s2"></div>
          <div className="piece s3"></div>
          <div className="piece s4"></div>
